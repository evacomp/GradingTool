    ...
    <div class="row">
    	<div class="col s4">
      		<div class="card-panel teal">
        		<p class="MenuTurmas"><a href="escolherperfilprofessor.jsp"> Perfil de Docente</a> </p> 
    	</div>
  	...
  	<div class="row">
    	<div class="col s4">
      		<div class="card-panel teal">
        		<p class="MenuTurmas"><a href="adicionarprofessorgrupo.jsp"> Adicionar a Grupo</a> </p>
      		</div>
    	</div>
  	</div>
